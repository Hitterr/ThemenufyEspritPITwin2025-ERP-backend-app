...
class StockService {
  ...
  buildFiltersQuery(filters) {
    ...
    if (filters?.minQuantity) {
      query.quantity = {
        ...query.quantity,
        $gte: parseFloat(filters?.minQuantity),
      };
    }
    if (filters?.maxQuantity) {
      query.quantity = {
        ...query.quantity,
        $lte: parseFloat(filters?.maxQuantity),
      };
    }
  ...
  async updateStock(id, updateData, restaurant) {
  ...
  async deleteStock(id, restaurant) {
    return await Stock.findOneAndDelete({ _id: id, restaurant });
  }
